...
!set sql_delimiter=/
CREATE OR REPLACE TASK build_tables_task
    WAREHOUSE='COL_WH'
    COMMENT='This task builds the Demographics, Housing, Parks(2x), POI and Weather_Climate tables in the Analytics schema'
AS BEGIN
    USE DATABASE COLORADO;
    USE SCHEMA ANALYTICS;
